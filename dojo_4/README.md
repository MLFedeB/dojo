...
La funcionalidad que buscamos implementar queda descripta por los tests de integración listados en el archivo [javascripts/test/solution.js](test/solution.js)
